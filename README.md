...
- <img src="https://github.com/stmSantana/ItemPiles/blob/main/Images/ScrapPile010.png"> Scrap metal 10 `<------>` Scrap metal pile 10
- <img src="https://github.com/stmSantana/ItemPiles/blob/main/Images/StonePile010.png"> Stone 10 `<------>` Stone pile 10
- <img src="https://github.com/stmSantana/ItemPiles/blob/main/Images/CharcoalPile010.png"> Charcoal 10 `<------>` Charcoal pile 10
...
(I added stackable behavior to item piles. This will stack items of the same type into one inventory icon. In addition, you can craft multiple at once. **"ItemPiles_NotStackable_ver.modcomponent" is a version that does not have that behavior.**)
* Move a **ItemPiles.modcomponent** (or ItemPiles_NotStackable_ver.modcomponent) file to the Mods folder.<br>
